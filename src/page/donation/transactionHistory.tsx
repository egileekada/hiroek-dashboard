        ...
        <div className=' w-full flex flex-col gap-6 ' >
            ...
            <div className=' w-full flex justify-center px-4 ' >
                <div className=' w-fit py-2 lg:flex hidden justify-center items-center rounded-lg bg-[#37137F1A] h-[54px] ' >
                    <CustomButton onClick={() => navigate("/dashboard/donation/history")} fontSize='14px' width='180px' bgColor={!index ? "#37137F" : "transparent"} color={index ? "#37137F" : "white"}  >Ticket Sales</CustomButton>
                    <CustomButton onClick={() => navigate("/dashboard/donation/history?withdrawals=true")} fontSize='14px' width='180px' bgColor={index ? "#37137F" : "transparent"} color={!index ? "#37137F" : "white"} >Withdrawals</CustomButton>
                </div>
                <div className=' w-full  py-2 lg:hidden justify-center items-center rounded-lg flex bg-[#37137F1A] h-[54px] ' >
                    <CustomButton onClick={() => navigate("/dashboard/donation/history")} fontSize='14px' width='100%' bgColor={!index ? "#37137F" : "transparent"} color={index ? "#37137F" : "white"}  >Ticket Sales</CustomButton>
                    <CustomButton onClick={() => navigate("/dashboard/donation/history?withdrawals=true")} fontSize='14px' width='100%' bgColor={index ? "#37137F" : "transparent"} color={!index ? "#37137F" : "white"} >Withdrawals</CustomButton>
                </div>
            </div>
            {!index && (
