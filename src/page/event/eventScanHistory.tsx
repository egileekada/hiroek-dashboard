            ...
            <div className=" w-full bg-white flex sticky top-0 flex-col gap-1 rounded-t-3xl pt-3 lg:px-3 px-4  " >
                <div className=" w-full flex items-center justify-center " >
                    <div className=' w-fit absolute left-4 ' >
                        <div onClick={()=> navigate(-1)} role='button' className=' w-11 h-11 lg:w-[62px] lg:h-[62px] flex justify-center bg-primary bg-opacity-15 rounded-[6px] items-center cursor-pointer ' style={{ boxShadow: "0px 2px 4px 0px #0000000D" }} >
                            <BackArrowIcon />
                        </div>
                    </div>
                    ...
                    <div className=" w-full flex items-center justify-between " >
                        <div className=" flex gap-2 items-center " >
                            ...
                            <div className=" flex flex-col " >
                                <Text className=" text-xs text-primary font-bold " >Carlos Suárez</Text>
                                <Text className=" text-[10px] text-primary text-opacity-50 font-bold " >5mins ago</Text>
                            </div>
                        </div>
