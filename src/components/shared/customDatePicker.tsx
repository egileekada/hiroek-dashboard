        ...
        <div>
            <div className=" w-full h-[39px] relative " >
                <input
                    ...
                    type={"date"} style={{ borderRadius: borderRadius ?? "5px" }} disabled={disable} value={(date || value) ? new Date(date ? date : value).toISOString().split('T')[0] : ""} name={name} className=" h-[39px] px-3 border-[#37137F] border-opacity-30 border-[1.5px] outline-none hover:border-[#37137F80] active:border-[#37137F80] focus:border-[#37137F80] bg-transparent w-full text-sm font-medium text-primary " />
