...
export default function ProfileForm() {
    return ( 
        <div className=' w-full max-w-[607px] flex flex-col gap-4 lg:px-0 px-4 ' >
            <div className=' w-full h-[300px] rounded-[24px] relative bg-primary ' >
                <button className=' w-fit px-6 h-[57px] rounded-[44px] bg-[#FFFFFF26] absolute top-4 right-4 font-extrabold text-white ' >Upload Organization Logo</button>
            </div>
            <div className=' w-full flex flex-col gap-4 pb-6 mt-3 ' >
                <div className=" flex w-full flex-col gap-1 " >
                    ...
                    <CustomInput name="email" type="email" placeholder="Type event name here. . ." />
                </div>
                <div className=" flex w-full flex-col gap-1 " >
                    <Text className=" text-primary font-semibold text-sm " >Organization Description</Text>
                    <textarea placeholder="Type or search for venue..." className=" h-[111px] p-3 border-[#37137F] border-opacity-30 outline-none border-[1.5px] hover:border-[#37137F80] active:border-[#37137F80] focus:border-[#37137F80] rounded-[10px] bg-transparent w-full text-sm font-semibold text-primary " />
                </div>
                <div className=" flex w-full flex-col gap-1 " >
