        ...
        <div className=" w-full flex flex-col gap-4 pb-6 " >
            <div className=" w-full p-5 flex flex-col gap-4 " style={{ boxShadow: "0px 4px 30px 0px #2E2D740D" }}  >
                ...
                <div className=" flex w-full flex-col gap-1 " >
                    ...
                    <textarea placeholder="Type community description here. . ." className=" h-[156px] p-3 border-[#37137F80] border-[1.5px] hover:border-[#37137F80] active:border-[#37137F80] focus:border-[#37137F80] rounded-[10px] bg-transparent w-full text-sm font-semibold text-primary " />
                </div>
