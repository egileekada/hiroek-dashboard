...
export default function CommunityFormEdit({values, setValue, isLoading, defaultdata}: {
    values: any;
    setValue: any;
    isLoading: boolean;
    defaultdata?: any
        ...
        <div className=" w-full flex flex-col gap-4 pb-6 " >
            ...
            <div className=" w-full py-5 px-4 lg:px-5 lg:p-5 flex flex-col gap-4 " style={{ boxShadow: "0px 4px 30px 0px #2E2D740D" }}  >
                <div className=" flex w-full flex-col gap-1 " >
                    ...
                    <CustomInput edit={true} value={values?.name ? values?.name : defaultdata?.name} setValue={setValue} name="name" type="text" placeholder="Type community name here. . ." />
                </div>
                <div className=" flex w-full flex-col gap-1 " >
                    <Text className=" text-primary font-semibold text-sm " >Community Description</Text>
                    <CustomInput edit={true}  setValue={setValue} value={values?.name ? values?.name : defaultdata?.description} name="description" type="text" textarea={true} placeholder="Type event description here. . ." />
